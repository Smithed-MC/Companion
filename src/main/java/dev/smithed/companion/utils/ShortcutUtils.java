...
public class ShortcutUtils {
    ...
    - ShortcutData data: the source data object from which a command will be created
    - CommandDispatcher<ServerCommandSource> dispatcher: the instance of the server command dispatcher which will be used to register the commands
     */
    ...
    - MinecraftServer server: server to dispatch command additions to
     */
    ...
    This method has one parameter
    - MinecraftServer server: server to dispatch command modifications and additions to
    ...
    It has three parameters, and they are:
    - int permission_level: specifies the server permission level of a user required to run a command - This applies to datapacks running it as well.
    - Identifier function: specifies the function to be run from the passed command
    - String alias: specifies the name of the new shortcut command
     */
